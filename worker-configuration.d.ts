/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2ae41f262730ff93eb97e25b767fdbf)
// Runtime types generated with workerd@1.20251125.0 2025-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./backend/index");
		durableNamespaces: "AdvisorAgent" | "WebSocketServer";
	}
	interface Env {
		KV: KVNamespace;
		SGDATA_KEY: string;
		...
		ADVISOR_AGENT: DurableObjectNamespace<import("./backend/index").AdvisorAgent>;
		WS_HANDLER: DurableObjectNamespace<import("./backend/index").WebSocketServer>;
		DB: D1Database;
		ANALYTICS_ENGINE: AnalyticsEngineDataset;
		MARKET_SCAN_WORKFLOW: Workflow<Parameters<import("./backend/index").MarketScanWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SGDATA_KEY" | "GEMINI_API_KEY" | "AI_GATEWAY_NAME" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
